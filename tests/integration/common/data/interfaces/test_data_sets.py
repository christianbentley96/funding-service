...
class TestReplaceUploadedDataSource:
    ...
    def test_replace_data_source_update_data(self, factories, dataset_with_column_of_each_type):
        gr1, gr2, gr3 = factories.grant_recipient.create_batch(3, grant=dataset_with_column_of_each_type.grant)
        ...
        assert (
            len(get_data_source(dataset_with_column_of_each_type.id, with_organisation_items=True).organisation_items)
            == 3
        )
        ...
        replace_uploaded_data_source(
            ...
            data_source=dataset_with_column_of_each_type,
            new_columns=[],
            all_headers=dataset_with_column_of_each_type.expected_headers,
            all_rows=[
                {
    ...
    def test_replace_data_source_remove_grant_recipient(self, factories, dataset_with_column_of_each_type):
        gr1, gr2 = factories.grant_recipient.create_batch(2, grant=dataset_with_column_of_each_type.grant)
        oi_id1 = factories.data_source_organisation_item.create(
            external_id=gr1.organisation.external_id,
            data_source=dataset_with_column_of_each_type,
            _data={"c_whole_number": 111, "c_decimal_number": "1.1", "c_just_text": "first version 1"},
    ...
    def test_replace_data_source_add_grant_recipient(self, factories, dataset_with_column_of_each_type):
        gr1, gr2 = factories.grant_recipient.create_batch(2, grant=dataset_with_column_of_each_type.grant)
        oi_id1 = factories.data_source_organisation_item.create(
            external_id=gr1.organisation.external_id,
            data_source=dataset_with_column_of_each_type,
    ...
    def test_remove_column_no_data(self, factories, dataset_with_column_of_each_type):
        gr1, gr2, gr3 = factories.grant_recipient.create_batch(3, grant=dataset_with_column_of_each_type.grant)

        assert len(get_data_source(dataset_with_column_of_each_type.id).schema.root.items()) == 6
        all_headers = dataset_with_column_of_each_type.expected_headers.split(",")
    ...
    def test_remove_column_with_data(self, factories, dataset_with_column_of_each_type):
        gr1, gr2 = factories.grant_recipient.create_batch(2, grant=dataset_with_column_of_each_type.grant)
    ...
    def test_replace_data_source_add_column_remove_column_and_update_data(
